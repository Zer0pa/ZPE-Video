...
<sub>02 · ZPE Video animated mechanics diagram · b-cell b-codec-mechanics cell-5 row-2</sub>
<figure>
...
<div><b>02 · MARKETS</b><span>ADJACENT FORECASTS</span></div>
      <div>
        <div>
          <div><span>AI video market</span><span></span><span>'33 · $42.3B</span></div>
          <div><span>Content detection / provenance</span><span></span><span>'30 · $39.7B</span></div>
          <div><span>AI image + video generator</span><span></span><span>'30 · $60.8B</span></div>
          <div><span>Video analytics</span><span></span><span>est. $12.4B</span></div>
          <div><span>AI content authentication</span><span></span><span>est. $3.1B</span></div>
        </div>
      </div>
...
<div><b>05.3 · BENCHMARKS</b><span>3 RECEIPT-CORE CASES</span></div>
      <div>
        ...
        <div>
          <div><span>Writer A</span><span></span><span>SHA=</span></div>
          <div><span>Writer B</span><span></span><span>SHA=</span></div>
          <div><span>Parquet</span><span></span><span>MISS</span></div>
        </div>
      </div>
...
<div><b>06.1 · COMPARATIVE RECEIPT VALIDATION</b><span>CROSS-WRITER SHA STABILITY</span></div>
      <div>
        <div>
          <div><span>Writer A</span><span></span><span>SHA=</span></div>
          <div><span>Writer B</span><span></span><span>SHA=</span></div>
          <div><span>Parquet</span><span></span><span>not stable</span></div>
          <div><span>Raw struct</span><span></span><span>not receipt</span></div>
        </div>
      </div>
