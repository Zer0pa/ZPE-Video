...
This repo is a private staging snapshot.

Its current value is structural clarity and evidence custody, not a claim of release-ready performance.
...
- the current known March 9 workspace verdict (`NO-GO`)
- the existence of a curated proof subset for future verification
- the current documentation boundary between public-facing repo content and workspace/operator residue
...
- independent blind-clone reproducibility

## Current Limit Matrix
